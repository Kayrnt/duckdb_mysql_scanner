...
EXTENSION_FLAGS=-DDUCKDB_OOT_EXTENSION_NAMES="mysql_scanner" -DDUCKDB_OOT_EXTENSION_MYSQL_SCANNER_PATH="$(PROJ_DIR)" -DDUCKDB_OOT_EXTENSION_MYSQL_SCANNER_SHOULD_LINK="TRUE" -DDUCKDB_OOT_EXTENSION_MYSQL_SCANNER_INCLUDE_PATH="$(PROJ_DIR)extension/include"
